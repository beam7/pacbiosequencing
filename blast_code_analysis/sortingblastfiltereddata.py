def main():
    ...
    with open("/Users/chenlab/Desktop/blastcodetesting/filtered_200memberblastresults.txt", "r") as input_file:
    ...
    for query, results in data.items():
        ...
        for result in sorted_results:
            if len(filtered_results) < 3 or result["e_value"] < 1e-10:
    ...
    with open("200membertop3blastresults.txt", "w") as output_file:
